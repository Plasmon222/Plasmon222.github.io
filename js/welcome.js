...
$.ajax({
    ...
    data: {
        key: 'LBHBZ-I4O6A-3AEKI-CKCM7-473R3-LUB36',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(118.89211, 31.32751, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
